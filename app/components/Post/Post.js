        ...
        <div className='post-info'>
            <div className='post-user-info'>
                ...
                <span className='contain-post-name-user'>
                    ...
                    <div className='post-tm-user'><span>1,634 views</span><span className='delimiter'>•</span><span>3h</span></div>
                </span>
            </div>
        </div>

        <div className='post-title'>Hello, this is Luffy basatard.</div>
                  ...
                  <div class="fr-ms-item-comment">
                      ...
                      <span>
                          ...
                          <div class="item-input-comment item-input-reply-comment" style= {{display: sampleData.curID === sampleData.ite.ID ? 'flex' : 'none'}}>
                              <span class="fr-image-item-comment">
                                  <img src={sampleData.userData.avatar} alt=""/>
                              </span>
                              <span>
