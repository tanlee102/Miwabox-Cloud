...
async function getData(sortingIndex, page, size) {
    ...
    switch (sortingIndex) {
        case 1: // Restricted
            url = `https://socialmediajavaapi.onrender.com/api/v1/posts/restricted?page=${page}&size=${size}`;
            break;
        case 2: // Muted
            url = `https://socialmediajavaapi.onrender.com/api/v1/posts/muted?page=${page}&size=${size}`;
            break;
        default: // Chronology (Ordered by ID)
            url = `https://socialmediajavaapi.onrender.com/api/v1/posts/orderById?limit=1000`;
            break;
    }
