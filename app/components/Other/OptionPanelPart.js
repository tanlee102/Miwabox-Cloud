...
const OptionPanelPart = ({isAdmin=false, isBan=false, isBlock=false, idMember=0}) => {
  ...
  return (
    ...
    <div class="pop-out-member-panel pop-out-member-panel-right pop-out-member-panel-admin" ref={targetRefExp} style={{display: "none"}}>
        <PopOutMemberPanel isAdmin={isAdmin} isBlock={isBlock} isBan={isBan} idMember={idMember}/>
    </div>
